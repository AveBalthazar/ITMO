...
public class StudyGroup implements Comparable<StudyGroup>, Serializable {
    ...
    /**
     * Метод для сравнения двух записей в таблице по их количеству студентов
     *
     * @param aStudyGroup - study group
     * @return "1" - если текущая study group больше, чем сравниваемая
     * "0" - если группы равны
     * "-1" - если эта группа меньше, чем сравниваемая
     * <p>
     * Приоритет полей:
     * StudentsCount - 100x
     * AverageMark - 50x
     * <p>
     * Если сравниваемые поля совпадают полностью, сравниваем по дате создания
     */
    @Override
