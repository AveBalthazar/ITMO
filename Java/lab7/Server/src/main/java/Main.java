        ...
        try (Scanner scanner = new Scanner(System.in);
            ...
            while (true) {
                ...
                RequestReceiver requestReceiver = new RequestReceiver(datagramSocket, packet,
                        new Invoker(receiver), forkJoinPool, executorService);
                forkJoinPool.invoke(requestReceiver);
            }
        } catch (IOException e) {
...
//        Connection db = dbConnector.connect();
        ...
        try {
            ...
            logger.warn("Проблемы с доступом к базе данных!");
            return null;
        }
    ...
    private static int getPort(Scanner scanner) {
        ...
        do {
            System.out.print("Пожалуйста, введите порт, на котором будет работать программа (1-65535): ");
