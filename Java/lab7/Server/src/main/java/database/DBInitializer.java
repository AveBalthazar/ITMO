...
/**
 * Класс для создания базы данных, таблиц в ней
 */
public class DBInitializer {
    ...
    public void initialize() throws SQLException {
        ...
        stmt.executeUpdate("CREATE TABLE IF NOT EXISTS s408624StudyGroups (" +
                "id int PRIMARY KEY," +
        ...
        stmt.executeUpdate("CREATE TABLE IF NOT EXISTS s408624Users (" +
