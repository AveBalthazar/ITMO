...
Тогда, заранее определив полюса разомкнутой системы, можем задать её нули такими, при которых найденный знаменатель передаточной функции замкнутой системы $P(s) + Q(s)$ будет иметь нужное число корней.
...
По заданию она должна иметь 3 неустойчивых полюса, тогда пусть её полюсами будут $s_1 = -4, s_2 = -5, s_{3} = 6, s_{4, 5} = 7 \pm j$. Тогда имеем:

\[
W_\text{З}(s) = \frac{P(s)}{P(s) + Q(s)} = \frac{P(s)}{P(s) + (s+1)(s-2)(s-3)(s+4-j)(s+4+j)} = \frac{P(s)}{(s+4)(s+5)(s-6)(s-7-j)(s-74+j)}.
\]

Приравняем знаменатели:

\[
P(s) + (s+1)(s-2)(s-3)(s+4-j)(s+4+j) = (s+4)(s+5)(s-6)(s-7-j)(s-74+j) \Leftrightarrow
\]

\[\Leftrightarrow
P(s) + s^5 - 12s^4 + 50s^3 - 70s^2 - 31s + 102 = s^5 -11s^4 - 26s^3 + 506s^2 - 20s - 6000 \Leftrightarrow
\]

\[\Leftrightarrow
P(s) = s^4 - 76s^3 + 576s^2 + 11s - 6102.
\]

Тогда искомая передаточная функция:

\[
W(s) = \frac{s^4 - 76s^3 + 576s^2 + 11s - 6102}{s^5 - 12s^4 + 50s^3 - 70s^2 - 31s + 102}.
\]
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys1/nulls_r.eps}
        \caption{Карта нулей разомкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys1/poluses_r.eps}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys1/nulls.eps}
        \caption{Карта нулей замкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys1/poluses.eps}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys1/step_r.eps}
        \caption{Переходная характеристика}
        \centerline{разомкнутой системы}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys1/step.eps}
        \caption{Переходная характеристика}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{ex1/sys1/niquist_r.eps}
...
График ЛАЧХ проходит через точку $L(\omega) = 0$ при частоте $\omega_1 \approx 2.81$, и после этой частоты принимает отрицательные значения. Рассмотрим требуемый по логарифмическому критерию Найквиста промежуток до $\omega_1$ по $\omega$. На отображённом промежутке график ЛФЧХ не проходит через критические отрезки, однако в пределе при $\omega \to 0$ будет достигнут один положительный переход на критической частоте $\varphi = 0$, засчитываемый за $1/2$. Тогда число неустойчивых полюсов замкнутой системы будет равняться $4-(1/2)\cdot2 = 3$ что подтверждает результат, полученный из анализа АФЧХ.
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys2/nulls_r.eps}
        \caption{Карта нулей разомкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys2/poluses_r.eps}
        \caption{Карта полюсов разомкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\\[1em]
\end{figure}\noindent\
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys2/nulls.eps}
        \caption{Карта нулей замкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys2/poluses.eps}
        \caption{Карта полюсов замкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\\[1em]
\end{figure}\noindent\
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys2/step_r.eps}
        \caption{Переходная характеристика}
        \centerline{разомкнутой системы}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys2/step.eps}
        \caption{Переходная характеристика}
        \centerline{замкнутой системы}
    \end{minipage}\\[1em]
\end{figure}\noindent\
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys3/nulls_r.eps}
        \caption{Карта нулей разомкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys3/poluses_r.eps}
        \caption{Карта полюсов разомкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\\[1em]
\end{figure}\noindent\
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys3/nulls.eps}
        \caption{Карта нулей замкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys3/poluses.eps}
        \caption{Карта полюсов замкнутой системы}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\\[1em]
\end{figure}\noindent\
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys3/step_r.eps}
        \caption{Переходная характеристика}
        \centerline{разомкнутой системы}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex1/sys3/step.eps}
        \caption{Переходная характеристика }
        \centerline{замкнутой системы}
    \end{minipage}\\[1em]
\end{figure}\noindent\
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys1/niquist_r_0.2.eps}
        \caption{Годограф первой системы, $k = 0.2$}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys1/niquist_r_3.eps}
...
Видно, что изменение значения параметра $k$ прямо пропорционально изменению ``величины'' годографа --- амплитуда системы подвергается умножению на $k$, соответственно, меняется и длина вектора, описывающего траекторию годографа. При этом петля, проходящая через точку $(0, 0)$, проходит через эту точку при любом $k$, то есть максимальное количество оборотов, которым годограф охватит критическую точку, равняется 1.
...
При $k \in (0, 4.5)$ замкнутая система имеет 0 неустойчивых полюсов. При $k > 4.5$ система окажется неустойчива с одним неустойчивым полюсом, так как годограф будет охватывать критическую точку по часовой стрелке один раз. При дальнейшем увеличении значения этого параметра годограф не будет охватывать критическую точку большее число раз, поэтому количество неустойчивых полюсов останется равным 1.

Переходные характеристики для каждой из определённых областей:

\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys1/step_3.eps}
        \caption{Переходная характеристика замкнутой}
        \centerline{системы при $k = 3$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys1/step_4.5.eps}
        \caption{Переходная характеристика замкнутой}
...
Для определения устойчивости по амплитуде проанализирую графики АЧХ и ЛФЧХ разомкнутой системы при единичном коэффициенте усиления:

\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys1/achh_r_1.eps}
        \caption{АЧХ разомкнутой}
        \centerline{системы при $k = 1$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys1/fchh_r_1.eps}
        \caption{ЛФЧХ разомкнутой}
        \centerline{системы при $k = 1$}
    \end{minipage}\\[1em]
\end{figure}\noindent\

Видно, что ФЧХ принимает значения от $-90$ до $180$, то есть классически определить частоту среза как ту, на которой ФЧХ принимает значение $-180$, тут не представляется возможным. Однако, взглянув на приведённый ранее график годографа для этой системы, можно увидеть, что ось $Im(W(\omega))$ годограф всё же пересекает, и можно предположить, что происходит это при частоте $180$ градусов, а не $-180$. Эта фаза достигается при $\omega = 0$, а амплитуда при приближении к этой частоте примерно равна $0.2222$. Тогда запасом по амплитуде можно считать значение

\[
A_\text{з} \approx \frac{1}{0.2222} \approx 4.5.
\]

Значение найденного запаса по амплитуде совпало с критическим значением коэффициента усиления $k$, найденным ранее.
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys2/niquist_r_0.1.eps}
        \caption{Годограф второй системы, $k = 0.1$}
        % \centerline{при $k_{\text{И}} = 0.3$, $g(t) = \sin{(0.45t)}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys2/niquist_r_0.2.eps}
...
Видно, что значение параметра $k$ влияет на масштаб годографа, точка $(0, 0)$ которого при любом значении коэффициента усиления остаётся неизменна. При $k = 2$ годограф охватывает критическую точку единожды против часовой стрелки, и при дальнейшем увеличении значения параметра количество охватов этой точки годографом не изменится.
...
При $k < 0.2$ замкнутая система неустойчива с 1 неустойчивым полюсом, при $k \in (0.2, \infty)$ --- устойчива асимптотически.

При $k = 1$ разомкнутая система не является асимптотически устойчивой, значит, реального действующего запаса устойчивости по амплитуде нет. Однако никто не мешает его найти, для нахождения критического значения коэффициента усиления. Для этого воспользуюсь графиками ФЧХ и АЧХ:

\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{ex2/sys2/achh_r_1.eps}
    \caption{АЧХ второй системы, $k = 1$}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{ex2/sys2/fchh_r_1.eps}
    \caption{ФЧХ второй системы, $k = 1$}
\end{figure}

$\varphi(\omega)$ принимает значение $-180^{\circ}$ при $\omega_{\text{кр}} \approx 0.446$, на этой частоте $A(\omega_{\text{кр}}) \approx 5.03$. $\omega_\text{кр} < \omega_\text{ср}$, поэтому запас по амплитуде действительно реальным запасом не является.

\[
A_\text{З} = \frac{1}{A(\omega_\text{кр})} = \frac{1}{5.03} \approx 0.1988.
\]

Значение запаса по амплитуде примерно совпало с рассчитанным критическим значением коэффициента усиления.

Переходные характеристики для каждой из определённых областей:

\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys2/step_0.1.eps}
        \caption{Переходная характеристика замкнутой}
        \centerline{системы при $k = 0.1$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex2/sys2/step_0.2.eps}
        \caption{Переходная характеристика замкнутой}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys1/T0.eps}
        \caption{Годограф Найквиста первой}
        \centerline{системы при $\tau = 0$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys1/T0.5.eps}
        \caption{Годограф Найквиста первой}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys1/T0.3.eps}
        \caption{Годограф Найквиста первой}
        \centerline{системы при $\tau = 0.3$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys1/T0.7.eps}
        \caption{Годограф Найквиста первой}
...
\begin{figure}[H]
    \centering \includegraphics[width=0.65\textwidth]{ex3/sys1/T1.eps}
    \caption{Годограф Найквиста первой}
...
\begin{figure}[H]
    \centering \includegraphics[width=0.60\textwidth]{ex3/sys1/A1.eps}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys1/step_0.eps}
        \caption{Переходная характеристика первой}
        \centerline{системы при $\tau = 0$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys1/step_0.1.eps}
        \caption{Переходная характеристика первой}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys1/step_0.20717.eps}
        \caption{Переходная характеристика первой}
        \centerline{системы при $\tau \approx \tau_{max}$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys1/step_0.21.eps}
        \caption{Переходная характеристика первой}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys2/T0.eps}
        \caption{Годограф Найквиста второй}
        \centerline{системы при $\tau = 0$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys2/T0.5.eps}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys2/T0.3.eps}
        \caption{Годограф Найквиста второй}
        \centerline{системы при $\tau = 0.3$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys2/T0.7.eps}
        \caption{Годограф Найквиста второй}
        \centerline{системы при $\tau = 0.7$}
    \end{minipage}\\[1em]
\end{figure}\noindent\
...
\begin{figure}[H]
    \centering \includegraphics[width=0.65\textwidth]{ex3/sys2/T1.eps}
...
\begin{figure}[H]
    \centering \includegraphics[width=0.6\textwidth]{ex3/sys2/poluses.eps}
...
\begin{figure}[H]
    \centering \includegraphics[width=0.65\textwidth]{ex3/sys2/A1_1.eps}
...
\begin{itemize}
    \item $\tau<0.0535$ --- замкнутая система неустойчива;
    \item $\tau>0.0535$ и $\tau<0.549$ --- замкнутая система асимптотически устойчива;
    \item $\tau>0.549$ --- замкнутая система неустойчива.
\end{itemize}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys2/step_0.eps}
        \caption{Переходная характеристика второй}
        \centerline{системы при $\tau = 0$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys2/step_0.0535.eps}
        \caption{Переходная характеристика второй}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys2/step_0.5.eps}
        \caption{Переходная характеристика второй}
        \centerline{системы при $\tau = 0.5$}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering \includegraphics[width=\textwidth]{ex3/sys2/step_0.55544.eps}
        \caption{Переходная характеристика второй}
        \centerline{системы при $\tau \approx \tau_{max}$}
    \end{minipage}\\[1em]
\end{figure}\noindent\
...
\begin{figure}[H]
    \centering \includegraphics[width=0.65\textwidth]{ex3/sys2/step_0.7.eps}
