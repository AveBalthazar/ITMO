...
Воспользуемся полученным ранее значением $I(t) = \frac{U_\text{ВХ}(t)}{R_1}$ и примем начальное условие $u(0) = 0$, тогда $u(t) = \frac{1}{C}\int_0^{t} \frac{U_\text{ВХ}(x)}{R_1}dx = \frac{1}{R_1C}\int_0^{t} U_\text{ВХ}(x)dx$. Далее сигнал идёт на резистор $R_2$, который 
