...
\[
s^2 Y(s) - s y(0) - \dot{y}(0) - \big(s Y(s) - y(0)\big) + 5 Y(s) = U(s) 
\]
\[
s^2 Y(s) - 0s - 5 - \big(s Y(s) - 0\big)+ 5 Y(s) = U(s) 
\]
\[
(s^2 - s + 5) Y(s) = U(s) + 5.
\]\
...
Пусть $W_{\text{об}}(s) = \frac{1}{s^2 - s + 5}$. Добавляя регулятор, мы меняем поведение системы:

\[
Y(s) = \frac{W_{\text{рег}}(s)W_{\text{об}}(s)}{1 + W_{\text{рег}}(s)W_{\text{об}}(s)}U(s) + \frac{5}{1 + W_{\text{рег}}(s)W_{\text{об}}(s)}.
\]\
...
\[
1 + W_{\text{рег}}(s)W_{\text{об}}(s) = 1 + \frac{k_0 + k_1s}{s^2-s+5} - 5(k_0 + k_1s) = 1(s^2-s+5) + k_0+k_1s = s^2 + (k_1-1)s+(k_0+5)=0
\]\ 
